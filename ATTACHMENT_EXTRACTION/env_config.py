...
# Additional work accounts (for multiple inbox access)
WORK_EMAIL_ADDRESS_2 = os.getenv('WORK_EMAIL_ADDRESS_2')
WORK_APP_PASSWORD_2 = os.getenv('WORK_APP_PASSWORD_2')

WORK_EMAIL_ADDRESS_3 = os.getenv('WORK_EMAIL_ADDRESS_3')
WORK_APP_PASSWORD_3 = os.getenv('WORK_APP_PASSWORD_3')
